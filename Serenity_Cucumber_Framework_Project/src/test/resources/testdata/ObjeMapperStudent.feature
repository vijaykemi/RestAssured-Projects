...
When I create a new student by providing the information firstName<firstName> lastName<lastName> email<email> programme<programme> course1<course1> course2<course2> using Objectmapper
Then I verify that the student with email<email> is created

Examples:

|	firstName	|	lastName	|	email						|	programme			|	course1	|	course2	|
|	Aadesh		|	Saanvi		|	Jamshed_Aadesh@gmail.com	|	Computer Science	|	Java	|	C++		|
